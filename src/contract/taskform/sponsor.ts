...
export const SponsorVault = new MoveStruct({
  name: `${$moduleName}::SponsorVault`,
  fields: {
    id: bcs.Address,
    form_id: bcs.Address,
    owner: bcs.Address,
...
export interface FormIdOptions {
  package?: string
  arguments: FormIdArguments | [vault: RawTransactionArgument<string>]
}
...
export interface BudgetRemainingOptions {
  package?: string
  arguments: BudgetRemainingArguments | [vault: RawTransactionArgument<string>]
}
...
export interface MaxSubmissionsOptions {
  package?: string
  arguments: MaxSubmissionsArguments | [vault: RawTransactionArgument<string>]
}
...
export interface UsedSubmissionsOptions {
  package?: string
  arguments: UsedSubmissionsArguments | [vault: RawTransactionArgument<string>]
}
...
export interface CanSponsorOptions {
  package?: string
  arguments: CanSponsorArguments | [vault: RawTransactionArgument<string>]
}
