...
export const SubmissionMeta = new MoveStruct({ name: `${$moduleName}::SubmissionMeta`, fields: {
        id: bcs.Address,
        form_id: bcs.Address,
...
export interface SubmissionBlobIdOptions {
    package?: string;
    arguments: SubmissionBlobIdArguments | [
        sub: RawTransactionArgument<string>
    ];
}
...
export interface IsValidStatusOptions {
    package?: string;
    arguments: IsValidStatusArguments | [
        status: RawTransactionArgument<number>
    ];
}
...
export interface IsValidPriorityOptions {
    package?: string;
    arguments: IsValidPriorityArguments | [
        priority: RawTransactionArgument<number>
    ];
}
