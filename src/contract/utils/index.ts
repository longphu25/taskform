...
export interface GetOptions<Include extends Omit<SuiClientTypes.ObjectInclude, 'content'> = {}>
  extends SuiClientTypes.GetObjectOptions<Include> {
  client: ClientWithCoreApi
}

export interface GetManyOptions<Include extends Omit<SuiClientTypes.ObjectInclude, 'content'> = {}>
